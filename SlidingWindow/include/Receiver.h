...
/**
 * This class provides a Receiver for a selective repeat protocol communciation
 * channel.
 */
class Receiver {
...
private:
  /**
   * A comparator that takes into account window wraparounds in its ordering of
   * sequence numbers
   */
